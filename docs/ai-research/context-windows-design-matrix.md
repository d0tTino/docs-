...
![Context windows design matrix showing model vs. token length](context-windows-design-matrix.svg)
...
This command outputs [`context-windows-design-matrix.svg`](context-windows-design-matrix.svg).
