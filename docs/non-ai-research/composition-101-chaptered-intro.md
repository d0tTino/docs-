...
- [Composition 101 — Chaptered Intro (with Links)](#composition-101--chaptered-intro-with-links)
  * [Chapter 1 — What “composition” actually means](#chapter-1--what-composition-actually-means)
    + [Why it matters](#why-it-matters)
  * [Chapter 2 — The Rule of Thirds (ROT): the starter grid](#chapter-2--the-rule-of-thirds-rot-the-starter-grid)
    + [How to use (quick recipes)](#how-to-use-quick-recipes)
    + [Where it came from](#where-it-came-from)
  * [Chapter 3 — Visual weight & hierarchy (why thirds “feel” good)](#chapter-3--visual-weight--hierarchy-why-thirds-feel-good)
    + [Mini-checklist while composing](#mini-checklist-while-composing)
  * [Chapter 4 — Cinematic framing: lead room, headroom, and motion](#chapter-4--cinematic-framing-lead-room-headroom-and-motion)
    + [Understanding lead room, nose room, and look space](#understanding-lead-room-nose-room-and-look-space)
    + [Understanding headroom](#understanding-headroom)
    + [Emotional effects of spacing (and when to break the rules)](#emotional-effects-of-spacing-and-when-to-break-the-rules)
    + [Lead room and headroom across media](#lead-room-and-headroom-across-media)
      - [Photography & cinematography](#photography--cinematography)
      - [Animation](#animation)
      - [Illustration & comics](#illustration--comics)
    + [Framing dynamic motion and implied action](#framing-dynamic-motion-and-implied-action)
    + [Practice drills for spatial awareness](#practice-drills-for-spatial-awareness)
    + [Using digital tools (Clip Studio Paint & Procreate)](#using-digital-tools-clip-studio-paint--procreate)
  * [Chapter 5 — Balance & negative space (calm vs. tension)](#chapter-5--balance--negative-space-calm-vs-tension)
  * [Chapter 6 — Beyond Thirds: Phi, spirals, and dynamic symmetry (optional tools)](#chapter-6--beyond-thirds-phi-spirals-and-dynamic-symmetry-optional-tools)
    + [Golden Ratio / Phi grid / spiral](#golden-ratio--phi-grid--spiral)
    + [Dynamic symmetry quickstart](#dynamic-symmetry-quickstart)
      - [Root rectangles at a glance](#root-rectangles-at-a-glance)
      - [Build the harmonic armature](#build-the-harmonic-armature)
      - [Why trade up from thirds?](#why-trade-up-from-thirds)
      - [Dynamic symmetry vs. thirds and φ](#dynamic-symmetry-vs-thirds-and-%CF%86)
      - [Digital workflows](#digital-workflows)
      - [Practice prompts](#practice-prompts)
  * [Chapter 7 — Value first: Notan & tonal design (the secret sauce)](#chapter-7--value-first-notan--tonal-design-the-secret-sauce)
    + [Value Grouping and Notan Design](#value-grouping-and-notan-design)
      - [What Is Notan?](#what-is-notan)
      - [How Notan Differs from Grayscale Studies](#how-notan-differs-from-grayscale-studies)
      - [Notan and Positive/Negative Space](#notan-and-positivenegative-space)
      - [Why Value Grouping Matters](#why-value-grouping-matters)
      - [Common Mistakes in Value Grouping (and How to Avoid Them)](#common-mistakes-in-value-grouping-and-how-to-avoid-them)
      - [How to Do a Notan Pass on an Image (Step by Step)](#how-to-do-a-notan-pass-on-an-image-step-by-step)
      - [Tools and Techniques for Digital Notan Studies](#tools-and-techniques-for-digital-notan-studies)
        * [Clip Studio Paint (CSP)](#clip-studio-paint-csp)
        * [Procreate (iPad)](#procreate-ipad)
      - [Examples of Value Grouping in Art History](#examples-of-value-grouping-in-art-history)
      - [Practice Drills to Improve Notan Awareness](#practice-drills-to-improve-notan-awareness)
      - [Conclusion](#conclusion)
  * [Chapter 8 — Color composition: mastering hue, saturation, and value](#chapter-8--color-composition-mastering-hue-saturation-and-value)
    + [Color Composition: Mastering Hue, Saturation, and Value for Visual Impact](#color-composition-mastering-hue-saturation-and-value-for-visual-impact)
    + [The three pillars: hue, saturation, and value](#the-three-pillars-hue-saturation-and-value)
      - [Hue](#hue)
      - [Value (lightness)](#value-lightness)
      - [Saturation (chroma)](#saturation-chroma)
    + [Value vs. color: structure and mood](#value-vs-color-structure-and-mood)
    + [Using color contrast to direct the eye](#using-color-contrast-to-direct-the-eye)
      - [Hue contrast (complementary colors)](#hue-contrast-complementary-colors)
      - [Warm vs. cool (temperature contrast)](#warm-vs-cool-temperature-contrast)
      - [Saturation contrast](#saturation-contrast)
      - [Balancing multiple contrasts](#balancing-multiple-contrasts)
    + [Palette strategies for harmony and impact](#palette-strategies-for-harmony-and-impact)
      - [Limited palettes for unity](#limited-palettes-for-unity)
      - [Color grouping and families](#color-grouping-and-families)
      - [Complementary accents and split schemes](#complementary-accents-and-split-schemes)
      - [Saturation zones and emphasis](#saturation-zones-and-emphasis)
    + [Real-world examples of strong color composition](#real-world-examples-of-strong-color-composition)
    + [Common mistakes in color composition](#common-mistakes-in-color-composition)
    + [Building a color plan: step by step](#building-a-color-plan-step-by-step)
    + [Drills to boost your color skills](#drills-to-boost-your-color-skills)
    + [Digital tips: using color layers and blending modes (Procreate & Clip Studio Paint)](#digital-tips-using-color-layers-and-blending-modes-procreate--clip-studio-paint)
    + [Conclusion](#conclusion-1)
  * [Chapter 9 — When to break the rule (on purpose)](#chapter-9--when-to-break-the-rule-on-purpose)
  * [Chapter 10 — 15-minute practice loop (do these today)](#chapter-10--15-minute-practice-loop-do-these-today)
  * [Chapter 11 — Set up helpful guides in your apps](#chapter-11--set-up-helpful-guides-in-your-apps)
  * [Chapter 12 — Erotic figure composition: shaping desire, tension, and flow](#chapter-12--erotic-figure-composition-shaping-desire-tension-and-flow)
    + [Why erotic composition differs from general figure drawing](#why-erotic-composition-differs-from-general-figure-drawing)
    + [Gesture, line of action, and body rhythm](#gesture-line-of-action-and-body-rhythm)
      - [Line of action and the S-curve](#line-of-action-and-the-s-curve)
      - [Body rhythm and flowing repetition](#body-rhythm-and-flowing-repetition)
      - [Expressive exaggeration](#expressive-exaggeration)
      - [Harmonizing multiple figures](#harmonizing-multiple-figures)
    + [Asymmetry, weight distribution, and counterbalance](#asymmetry-weight-distribution-and-counterbalance)
    + [Framing techniques for intimacy](#framing-techniques-for-intimacy)
      - [Selective cropping and proximity](#selective-cropping-and-proximity)
      - [Lead room and look space](#lead-room-and-look-space)
      - [Negative space and spatial balance](#negative-space-and-spatial-balance)
      - [Camera distance and angle](#camera-distance-and-angle)
      - [Managing tangents and clean silhouettes](#managing-tangents-and-clean-silhouettes)
    + [Focal points: guiding desire with face, core, hands, and gaze](#focal-points-guiding-desire-with-face-core-hands-and-gaze)
    + [Common mistakes in erotic compositions](#common-mistakes-in-erotic-compositions)
    + [Real-world reference points](#real-world-reference-points)
    + [Practice drills for sensual flow and framing](#practice-drills-for-sensual-flow-and-framing)
